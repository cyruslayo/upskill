...
*   `math_00_diagnostic.ipynb` is the recommended entry point for new learners.
*   The Level 0 foundations notebooks are the source-of-truth interactive curriculum.
*   All legacy math and algorithm notebooks have been batch-migrated into the interactive shell.
*   Instructor solution notebooks are complete and validated against the shared solution bank.

## Notebook Index
Click any notebook title to open the corresponding lesson file.

### Level 0: Foundations Track
*   [Diagnostic: Placement and Recall](mathematics/notebooks/math_00_diagnostic.ipynb)
*   [Math 00A: Python Arithmetic and Variables](mathematics/notebooks/math_00_python_arithmetic.ipynb)
*   [Math 00B: Pre-Algebra Foundations](mathematics/notebooks/math_00_pre_algebra.ipynb)
*   [Math 00C: Functions, Tables, and Graphs](mathematics/notebooks/math_00_functions_and_graphs.ipynb)

### Math Foundations Track
*   [Math Notebook 01: Algebra - Linear Equations](mathematics/notebooks/math_01_algebra_linear_equations.ipynb)
*   [Math Notebook 02: Calculus - Derivatives & Power Rule](mathematics/notebooks/math_02_calculus_derivatives.ipynb)
*   [Math Notebook 03: Calculus - Chain Rule](mathematics/notebooks/math_03_calculus_chain_rule.ipynb)
*   [Math Notebook 04: Calculus - Local Extrema](mathematics/notebooks/math_04_calculus_local_extrema.ipynb)
*   [Math Notebook 05: Linear Algebra - Vectors and Dot Products](mathematics/notebooks/math_05_linear_algebra_vectors.ipynb)
*   [Math Notebook 06: Linear Algebra - Matrices and Transformations](mathematics/notebooks/math_06_linear_algebra_matrices.ipynb)
*   [Math Notebook 07: Calculus - Differential Equations (Euler)](mathematics/notebooks/math_07_calculus_differential_equations.ipynb)

### Part I: Hello World
*   [Notebook 01: Introductory Coding Exercises](mathematics/notebooks/01_introductory_coding.ipynb)
*   [Notebook 02: Number Systems](mathematics/notebooks/02_number_systems.ipynb)
*   [Notebook 03: Recursive Sequences](mathematics/notebooks/03_recursive_sequences.ipynb)
*   [Notebook 04: Simulating Randomness](mathematics/notebooks/04_simulating_randomness.ipynb)
*   [Notebook 05: Roulette Wheel Selection](mathematics/notebooks/05_roulette_wheel.ipynb)
*   [Notebook 06: Cartesian Product](mathematics/notebooks/06_cartesian_product.ipynb)

### Part II: Searching and Sorting
*   [Notebook 07: Brute Force Search & Cryptography](mathematics/notebooks/07_brute_force_crypto.ipynb)
*   [Notebook 08: Backtracking](mathematics/notebooks/08_backtracking_magic_squares.ipynb)
*   [Notebook 09: Estimating Roots](mathematics/notebooks/09_estimating_roots.ipynb)
*   [Notebook 10: Single-Variable Gradient Descent](mathematics/notebooks/10_single_variable_gd.ipynb)
*   [Notebook 11: Multivariable Gradient Descent](mathematics/notebooks/11_multivariable_gd.ipynb)
*   [Notebook 12: Basic Sorting](mathematics/notebooks/12_basic_sorting.ipynb)
*   [Notebook 13: Advanced Sorting](mathematics/notebooks/13_advanced_sorting.ipynb)

### Part III: Objects
*   [Notebook 14: Basic Matrix Arithmetic](mathematics/notebooks/14_basic_matrix_arithmetic.ipynb)
*   [Notebook 15: Reduced Row Echelon Form](mathematics/notebooks/15_reduced_row_echelon_form.ipynb)
*   [Notebook 16: K-Means Clustering](mathematics/notebooks/16_k_means_clustering.ipynb)
*   [Notebook 17: Tic-Tac-Toe and Connect Four](mathematics/notebooks/17_tic_tac_toe_connect_four.ipynb)
*   [Notebook 18: Euler Estimation](mathematics/notebooks/18_euler_estimation.ipynb)
*   [Notebook 19: SIR Model For the Spread of Disease](mathematics/notebooks/19_sir_model.ipynb)
*   [Notebook 20: Hodgkin-Huxley Model](mathematics/notebooks/20_hodgkin_huxley.ipynb)
*   [Notebook 21: Hash Tables](mathematics/notebooks/21_hash_tables.ipynb)
*   [Notebook 22: Simplex Method](mathematics/notebooks/22_simplex_method.ipynb)

### Part IV: Regression and Classification
*   [Notebook 23-25: Regression via Pseudoinverse](mathematics/notebooks/23-25_regression_pseudoinverse.ipynb)
*   [Notebook 26: Overfitting and Bias-Variance Tradeoff](mathematics/notebooks/26_overfitting_bias_variance.ipynb)
*   [Notebook 27-28: Regression via Gradient Descent](mathematics/notebooks/27-28_regression_gradient_descent.ipynb)
*   [Notebook 29: K-Nearest Neighbors](mathematics/notebooks/29_k_nearest_neighbors.ipynb)
*   [Notebook 30: Naive Bayes](mathematics/notebooks/30_naive_bayes.ipynb)

### Part V: Graphs
*   [Notebook 31: Breadth-First and Depth-First Traversals](mathematics/notebooks/31_bfs_dfs.ipynb)
*   [Notebook 32-33: Shortest Paths and Dijkstra's Algorithm](mathematics/notebooks/32-33_shortest_paths_dijkstra.ipynb)
*   [Notebook 34: Decision Trees](mathematics/notebooks/34_decision_trees.ipynb)
*   [Notebook 35-36: Neural Network Regressors & Backpropagation](mathematics/notebooks/35-36_neural_networks.ipynb)

### Part VI: Games
*   [Notebook 37-39: Minimax and Game Trees](mathematics/notebooks/37-39_minimax_game_trees.ipynb)
*   [Notebook 40-42: Neuroevolution](mathematics/notebooks/40-42_neuroevolution.ipynb)
*   [Notebook 43: Convolutional Neuroevolution](mathematics/notebooks/43_convolutional_blondie24.ipynb)
